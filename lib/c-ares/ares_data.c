  ...
  switch (ptr->type)
	...
	break;
      ...
      case ARES_DATATYPE_SRH_REPLY:
        if (ptr->data.srh_reply.srh_length)
          ares_free(ptr->data.srh_reply.srh);
